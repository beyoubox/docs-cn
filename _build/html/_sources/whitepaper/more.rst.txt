...
If BEYOU goes one step further and implements a multi-proxy application vnTOR,
vnTOR has obvious advantages over the original Tor network.
In other words, an ecosystem that uses Stoken can motivate the participation of nodes
...
According to the actual development of the Beyou Network project
...
and application by rewarding Stokens.
...
Future services based on Beyou Network will also be settled using Stoken
------------------------------------------------------------------------

Benefit from the stable value anchor design of Stoken,
which makes Stoken closer to the true currency
(value scale is stable, convenient to hold and circulate).
In a sense, not only the software and services officially developed by Beyou Network.
With the promotion of development support policies and support funds,
more third-party software will also use Stoken for service settlement.
