...
in which :ref:`stoken` will be the only measure of value and means of payment
in such a sustainable and healthy environment.
It is clear that the basic design of 1 Stoken = 100GB
after ecological maturity will ensure that
the price of Stoken is not destined to deviate too much
from the anchoring of its actual use value.
We expect users with real demands to buy Stokens through exchanges
or other channels and use it for appropriate network services.
Of course, the value logic of Stoken is so clear that proper investment is also a good choice.
...
74.53% of the Stokens will ultimately be held by users.


.. _distribution_plan:

Stoken Distribution plan
-----------------------
...
Air Drops 2%
   For ETH holders and promotion before/during the Stoken Public-Sale.


Token Sale 23.5%
   For Stoken Public-Sale.
...
DAPPs Support Plan 10%
   It is used to enrich Beyou Network ecology,
